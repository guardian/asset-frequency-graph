...
module.exports = function (config) {
    var Promise   = require('es6-promise').Promise,
        ...
        reqconfigPath = path.join(frontend, config.requireConfig),
        reqconfig = config.gruntJit ? require(reqconfigPath)(null, {}) : require(reqconfigPath);
